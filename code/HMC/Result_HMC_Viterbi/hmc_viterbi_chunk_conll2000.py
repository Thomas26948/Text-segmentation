...
from HMC_Viterbi_Restorator import HMC_Viterbi_Restorator
...
train_set, test_set = load_conll2000(path = "../../Dataset/CoNLL2000/")
...
hmc_fb = HMC_Viterbi_Restorator(Omega_X, Pi, A, B)
...
print("Recall:", recall)
print("Chunking F1 CoNLL 2000:", f1, "\n")
